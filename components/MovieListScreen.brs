...
function createPosterItem(itemData as Object, visualIndex as Integer, absoluteIndex as Integer) as Object
    ...
    label = CreateObject("roSGNode", "Label") : label.id = "itemLabel" : label.translation = [0, m.posterH + 6] : label.width = m.posterW : label.height = 28 : label.font = "font:SmallSystemFont" : label.color = "#DDE6F3" : label.text = getMovieName(itemData) : label.horizAlign = "center"
